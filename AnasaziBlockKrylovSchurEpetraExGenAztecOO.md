...
[click here.](http://trilinos.sandia.gov/packages/docs/dev/packages/anasazi/doc/html/BlockKrylovSchur_2BlockKrylovSchurEpetraExGenAztecOO_8cpp-example.html#_a20)  That example is most likely to be up to date, since it passes nightly tests.  If that example is not up to date or available, you may use the example code below.
