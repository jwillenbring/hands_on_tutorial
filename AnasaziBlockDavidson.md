This example computes a few eigenvalues of largest magnitude of an eigenvalue problem A x = λ x, using Anasazi's implementation of the Block Davidson method.
