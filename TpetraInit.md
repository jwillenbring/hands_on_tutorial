...
[Tpetra](http://trilinos.sandia.gov/packages/tpetra/) applications have a slightly different initialization procedure than [Epetra](http://trilinos.sandia.gov/packages/epetra/) applications, because Tpetra uses a different communicator object.  This example shows how to initialize an application and get the Tpetra communicator corresponding to MPI\_COMM\_WORLD.
